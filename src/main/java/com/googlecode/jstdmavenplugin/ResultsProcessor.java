...
class ResultsProcessor {
    ...
    public
    void processResults(String output) throws MojoExecutionException {
        ...
        if (testRunnerResults == null || testRunnerResults.hasFailures()) {
            ...
            if (testRunnerResults == null) {
                ...
                if ((failures > 0 && failOnFailure) || (errors > 0 && failOnError)) {
                    throw new MojoExecutionException(errorString.toString());
                }
            }
    ...
    private
    TestRunnerResults extractResults(String output) throws MojoExecutionException {
